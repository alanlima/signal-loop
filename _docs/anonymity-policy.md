...
| P3 publication window | ISO week Monday 00:00:00 in the organisation's IANA timezone inclusive to the following local Monday exclusive; persist both boundaries as UTC instants and close once at that boundary | User decision for #12 on 2026-09-07. No live reports, rolling-window counts, or late additions. A submission at the boundary belongs to the next open week. DST weeks may differ from 168 elapsed hours. |
...
| --- | --- | --- | --- |
| Drafts | Own editing and scoped adaptive follow-up service | Earliest selected project-week closure, global UTC journey-week end, or 7 days after creation; submission/discard deletes earlier, per user-approved #13 combined journey rule | No draft text in logs, analytics, crash reports or admin screens; no draft ID carried into published evidence |
...
| Opening invitation delivery | One invitation per verified natural person/organisation window to their designated verified primary email; missing/ambiguous contact withholds (user-approved #22 rule) | 7 days after window closure | Identity-side delivery state only; no response/content/source links or respondent-status targeting; no email address or message body persisted in delivery state |
| Global journey terminal status | Own combined-journey admission only; principal/global UTC week and completed/discarded/expired state | 7 days after global UTC week-end | No selected project list, source/content references, feedback IDs, precise completion timestamp or persisted submitted batch identifier |
